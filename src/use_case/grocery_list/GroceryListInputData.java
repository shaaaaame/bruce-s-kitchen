...
public class GroceryListInputData {
    ...
    GroceryListInputData(int grocery_id, int user_id, LocalDateTime date_created, Map<String, String> ingredients){
    ...
    LocalDateTime getDate(){ return this.date_created; }
