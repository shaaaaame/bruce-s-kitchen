...
import data_access.RecipeDeserializer;
import data_access.RecipeSerializer;
...
public class Main {
    ...
    private static final Map<UUID, Recipe> recipeMap = new HashMap<UUID, Recipe>();
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        try {
            ...
            recipeList = objectMapper.readValue(apiCall("tomato"), objectMapper.getTypeFactory().constructCollectionType(List.class, Recipe.class));
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
    ...
    public static void addToRecipeMap(List<Recipe> recipeList){
